...
// German translation provided by NorthMole
  ...
  const msg = {
    nl_NL: {
      ...
      messages: {
        ...
        maxlootConflict:
          'Activeer slechts één van de twee sjabloon B-opties: "volle buit" OF muurbreker bij gele rapporten!',
        ramNeedsLosses:
          'De muurbreker-optie vereist dat "Verstuur farm naar dorpen met gedeeltelijke verliezen" is ingeschakeld!',
      },
    },
    hu_HU: {
      missingFeatures:
      ...
      messages: {
        ...
        maxlootConflict:
          'Csak az egyik B sablon opciót kapcsold be: „teli zsákmány" VAGY faltörő a sárga jelentéseknél!',
        ramNeedsLosses:
          'A faltörő opcióhoz be kell kapcsolni a részleges veszteségű falvak támadását!',
      },
    },
    // improved by NorthMole
    de_DE: {
      missingFeatures:
      ...
      options: {
        ...
        warning:
          '<b>Warnung:</b><br>- Stelle sicher, dass A als deine Standard-Mikrofarm eingestellt ist<br>- Vorlage B ist entweder eine größere Mikrofarm (für die Option „Volle Beute") ODER deine Wallbrecher-Vorlage mit Rammböcken/Katapulten (für gelbe Berichte) - aktiviere immer nur die dazu passende Option<br>- Stelle sicher, dass die Farm-Filter korrekt eingestellt sind, bevor du das Skript benutzt',
        filterImage:
          'https://higamy.github.io/TW/Scripts/Assets/farmGodFilters.png',
      ...
      messages: {
        ...
        maxlootConflict:
          'Bitte nur eine der beiden Vorlage-B-Optionen aktivieren: „Volle Beute" ODER Wallbrecher bei gelben Berichten!',
        ramNeedsLosses:
          'Die Wallbrecher-Option benötigt die aktivierte Option „Farmen zu Dörfern mit teilweisen Verlusten senden"!',
      },
    },
    int: {
      missingFeatures:
      ...
      options: {
        ...
        warning:
          '<b>Warning:</b><br>- Make sure A is set as your default microfarm<br>- Template B is either a larger microfarm (for the "full loot" option) OR your wall breaker template with rams/catapults (for yellow reports) - only enable the matching option<br>- Make sure the farm filters are set correctly before using the script',
        filterImage:
          'https://higamy.github.io/TW/Scripts/Assets/farmGodFilters.png',
      ...
      messages: {
        ...
        maxlootConflict:
          'Please enable only one of the two template B options: "full loot" OR wall breaker on yellow reports!',
        ramNeedsLosses:
          'The wall breaker option requires "Send farm to villages with partial losses" to be enabled!',
      },
    },
  };
        ...
        $.when(buildOptions()).then((html) => {
          ...
          $('.optionButton')
            ...
            .on('click', () => {
              ...
              // improved by NorthMole
              if (optionMaxloot && optionRam) {
                UI.ErrorMessage(t.messages.maxlootConflict);
                return;
              }
              if (optionRam && !optionLosses) {
                UI.ErrorMessage(t.messages.ramNeedsLosses);
                return;
              }
