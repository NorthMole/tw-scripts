      ...
      yellowTargets.forEach((targetCoord) => {
        ...
        for (let i = 0; i < orderedOrigins.length; i++) {
          ...
          if (timeDiff) {
            ...
            // Ziel ist versorgt, aus der normalen Planung entfernen, damit es
            // nicht doppelt (z.B. nochmal mit Vorlage A) angegriffen wird.
            delete data.farms.farms[targetCoord];
            break;
          }
        }
      });
